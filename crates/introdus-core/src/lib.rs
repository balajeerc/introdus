...
//! the typed `.env` config, filesystem paths, the embedded container-side
//! bash assets, the coding-agent registry, and thin `podman`/`tmux`/`git`
//! process wrappers. Modules land milestone by milestone (see PLAN.md).
