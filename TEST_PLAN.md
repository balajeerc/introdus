...
| 16.3 | Deploy-key path validation + ed25519 generation + pubkey print | ⚠️ (tilde expand tested) | 4 | give a missing path; accept generation; confirm keypair + pubkey shown |
