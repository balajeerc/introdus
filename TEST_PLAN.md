...
| TA161 | Wizard direct-mode branch, end to end over a pty: opting into paseo then choosing DIRECT records `PASEO_MODE=direct` in `.env` and leaves `paseo.sh` out of the allowlist | ✅ pty `introdus-cli` (`wizard_pty.rs`) | 2 | ta161_wizard_paseo_direct_mode_records_mode_and_skips_relay_host |
